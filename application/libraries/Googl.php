...
/**
* This class is based on https://github.com/sebi/googl-php
*/
...
class Googl
{
    ...
    function __construct() {
        ...
        $this->ci->load->config('googl_api');
        $apiKey = $this->ci->config->item('google_api_key');
        ...
        if ( $apiKey != null ) {
            ...
            echo "Please set up an api key correctly in the config file.\n";
        }
